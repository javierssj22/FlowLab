...
for(const kind of ['signal','adc','pwm','feedback','types','processing','burst','module','i2cframe','spectrum','sensor16','xy','peripherals'])writeFileSync(new URL(`${kind}.flowlab.json`,root),JSON.stringify(example(kind),null,2)+'\n');
